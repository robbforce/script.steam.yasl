...
Else
{
  If (BigPicture = "true")
  {
    ...
    Run, SteamDir . " \" . SteamExe . " " . SteamCommands . " steam://open/bigpicture",, UseErrorLevel, varPID
  }
  Else
  {
    ; Launch Steam and store the PID in a local variable.
    Run, SteamDir . " \" . SteamExe . " " . SteamCommands,, UseErrorLevel, varPID
  }
...
If (QuitOrMinKodi = "0")
{
  ...
  If (ErrorLevel = 0 And ForceKillTime > 0)
  {
    Run, comspec . " /c timeout /t " . ForceKillTime . " && tskill " . varPID,, Hide
  }
}
...
WinWaitActive, "ahk_exe " . SteamWindowExe,, 30
If (ErrorLevel = 0)
{
